...
Select Case Ayuda
    Case 1
        Select Case SubAyuda
            Case 1
                ...
                vbCrLf & ". Podrás atacar tanto a aquellos que no le hayan jurado fidelidad a la Alianza, sin importar si le juraron fidelidad a Lord Thek o si decidieron no ser fieles a ninguno de los dos. De todas formas, la Alianza tendrá en cuenta para sus recompensas sólo las muertes de quienes son fieles a Lord Thek." & vbCrLf & ". No podrás atacar a los guardias de la Alianza que vigilan día y noche las ciudades de la Alianza del Fúrius." & vbCrLf & ". Si en algún momento decides dejar de serle fiel a la Alianza, los guardias de las ciudades te perseguirán. Además, la Alianza ya no te permitirá volver con él nunca." & vbCrLf & ". Una vez que elegiste jurarle fidelidad a la Alianza, ya no podrás jurarle fidelidad al Lord Thek jamás, por más que hayas abandonado tu anterior vida." & vbCrLf & ". Tendrás la posibilidad de pertenecer a la Alianza del Fúrius."
    ...
    Case 0
        Select Case MiClase
             ...
             Case HECHICERO
                 FrmAyuda.Label1.Caption = "Mago" & vbCrLf & vbCrLf & "El mago es un personaje de poca vida que utiliza la Furia del Fúrius (mejor hechizo de mago) y puede llegar a tener más de 2000 de mana." & vbCrLf & vbCrLf & "Nigromante" & vbCrLf & vbCrLf & "El nigromante es un personaje de poca vida que puede usar el mejor hechizo de invocacion y llegar a tener como máximo 2000 de mana."
