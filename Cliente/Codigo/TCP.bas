    ...
    Select Case sdata
        ...
        Case "LOGGED"
            ...
            If tipf = "1" And PrimeraVez Then
                 ...
                 PrimeraVez = False
            End If
            Call SetMusicInfo("", "", "Jugando FúriusAo " & "- " & "[" & UserName & "]", "Games", "{1} {0}")
    ...
    frmTorneo.Label2 = frmTorneo.List1.ListCount
       ...
       Case "PPO" ' Case para Objetos
        ...
        Case "EST"
            ...
            Else
                frmMain.LvlLbl.Caption = "¡Nivel Máximo!" 'UserLvl
                frmMain.exp.Caption = "¡Nivel Máximo!"
               ' FormInfo.lblPorcLvl = "¡Nivel Máximo!"
            End If
            ...
            Select Case var1
                Case 0
                    ...
                    Select Case var2
                        ...
                        Case 1
                            frmEstadisticas.Label4(2).Caption = "Fue de la Alianza del Fúrius"
                        Case 2
