...
Select Case MiClase
    ...
    Case EXPERTO_MINERALES
        ...
        Label4.Caption = "El minero, como bien dice su nombre, mina oro, plata y hierro en las tierras del Furius. Podrán encontrar importantes minas en el continente aunque la más importante será alcanzable solo mediante navegación."
    ...
    Case ORDEN
        ...
        Label5.Caption = "Pasa gran parte de su vida dentro del templo, orando por las almas de las personas vivas y muertas del mundo. Así como los paladines, pueden ser buenos o malos dependiendo de la deidad a la que sigan. Son considerados las personas más cultas de las Tierras del Furius."
    ...
    Case BANDIDO
        ...
        Label5.Caption = "Algunos viven una vida de lujuria mientras que otros simplemente subsisten con lo que logran hurtar. Son los personajes más vagos de las Tierras del Furius aunque tienen una particular habilidad para aparecer de la nada, robar y seguir su camino sin ser vistos."
        
        Label3.Caption = "Puedes dedicarte al hurto o preferir navegar los mares de las Tierras de Fúrius como un pirata."
