...
'FIXIT: '#End If' no se actualiza de forma fiable a Visual Basic .NET                      FixIT90210ae-R2789-H1984
    ...
    Dim lpStr&
    Dim retString$
'FIXIT: Reexmplazar la función 'String' con la función 'String$'.                           FixIT90210ae-R9757-R1B8ZE
...
Function GetWSAErrorString(ByVal errnum&) As String
    ...
    Select Case errnum
       ...
       ' Case 11004: GetWSAErrorString = "Valid name, no data record of requested type." FuriusAO
        Case Else:
    End Select
End Function
