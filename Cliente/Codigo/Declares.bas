...
Public ObjBotanica(0 To 100) As Integer
...
Public NoPuedeUsarC As Boolean
...
Public GrhPathX As String

Public BancoT As Long

 Public Const FXMASR = 2
 Public Const FXMASG = 4
 Public Const FXMASB = 8
 Public Const FXMENOSR = 16
 Public Const FXMENOSG = 32
 Public Const FXMENOSB = 64
